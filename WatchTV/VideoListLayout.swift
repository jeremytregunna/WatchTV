...
public enum VideoListLayoutSpacingMode {
    case fixed(spacing: CGFloat)
    case overlap(visibleOffset: CGFloat)
}

open class VideoListLayout: UICollectionViewFlowLayout {
    ...
    open var spacingMode = VideoListLayoutSpacingMode.fixed(spacing: 40)
