...
struct ChannelService {
    static let all: [Channel] = [one, two, three, four, five]
    ...
    static let five: Channel = Channel(name: "Channel 5", url: URL(string: "http://samplestreamseu.streaming.mediaservices.windows.net/056163f2-b8ed-4023-abef-753dbe9b3638/7d55569c-54e0-4954-8bea-7dbe19f039f5.ism/Manifest(format=m3u8-aapl)"))
}
